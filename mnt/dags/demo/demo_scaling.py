...
with DAG("demo_scaling", default_args=default_args, schedule_interval=None) as dag:
    ...
    t4 = BashOperator(task_id="t4", bash_command="echo t4")
    t5 = BashOperator(task_id="t5", bash_command="echo t5")
